package com.drevnitskaya.currencyconverter.data.source.local

import com.drevnitskaya.currencyconverter.R

//
//interface CurrencyLocalSource {
//    var currencyFlags: Map<String, Int>
//}
//
//class CurrencyLocalSourceImpl : CurrencyLocalSource {
//    override var currencyFlags: Map<String, Int> = mapOf(
...
val currencyFlags: Map<String, Int> = mapOf(
    DEFAULT_BASE_CURRENCY_CODE to R.drawable.ic_eur_flag,
    "AUD" to R.drawable.ic_aud_flag,
    "BGN" to R.drawable.ic_bgn_flag,
    "BRL" to R.drawable.ic_brl_flag,
    "CAD" to R.drawable.ic_cad_flag,
